 ...
 * On mobile devices (<= 600px): Clean, 100% native edge-to-edge fullscreen
 */
export default function IPhoneFrame({ children }) {
  ...
  // Smooth spring physics for desktop mouse parallax
  ...
  return (
    ...
    >
      {/* Physical Titanium Hardware Buttons (Desktop only) */}
      {!isMobile && (
        <>
      ...
      <div className="iphone-device-frame">
        {/* Outer Titanium Rim & Corner Highlights (Desktop only) */}
        {!isMobile && <div className="chassis-highlight-rim" />}

        {/* Dynamic Island / Hardware Notch (Desktop only) */}
        {!isMobile && (
